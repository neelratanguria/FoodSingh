...
public class Signup_OTP extends AppCompatActivity {
    ...
    private void send_otp(final String mob, final String pass, final String nam, final String ema) {
        ...
        String Url="https://control.msg91.com/api/sendotp.php?authkey=112452AB1seNQy572e2e51&mobile="+mob+"&message=Your%20OTP%20is%20%23%23OTP%23%23%20.%20It%20is%20Valid%20for%2010%20minutes%20only.&sender=FSINGH&otp_expiry=10";
